...
all_videos = ['QokL8kNka9g', 'e45vsP9CM2c', '19P6qybcoUE', '01560685f81',
              ...
              'a8c1424ebcd', 'alzo8uZzhpk', '0318dd3e7e3', 'v_AngiPw1wc',
              '3d384b2969e', '9NM1_cC5PfI', 'eb984ec0cf5', 'ZjjgFgisJwI',
              'fTFTk_q8dh0', '6iSraYGcHBk', 'B5K_QYc_Y2o', 'HWpy-ZzKSQE',
              'GkfnPAgdaUI', 'G2lrwv61Mss', '9DhftZeReiI', '5uKdXnreV1s',
...
for split in splits:
    ...
    for vid in sorted(data.keys()):
        ...
        if split == 'train' and vid_src not in train_videos:
            continue
        if split == 'val' and vid_src not in val_videos:
            continue
        if split == 'test' and vid_src not in test_videos:
            continue
