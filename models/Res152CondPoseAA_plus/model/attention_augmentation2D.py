...
# augmented_conv1 = AugmentedConv(in_channels=3, out_channels=20, kernel_size=3, dk=0.1, dv=0.1, Nh=2, relative=True, stride=2, shape=16).to(device)
...
#
# augmented_conv2 = AugmentedConv(in_channels=3, out_channels=20, kernel_size=3, dk=0.1, dv=0.1, Nh=2, relative=True, stride=1, shape=32).to(device)
