...
source_obj_dets  = '/content/drive/MyDrive/DoAn/SurgicalHands/hand_detections'
...
target_json_dir = '/content/drive/MyDrive/DoAn/SurgicalHands/surgical_hands_release/pub_surgical_dets/'
